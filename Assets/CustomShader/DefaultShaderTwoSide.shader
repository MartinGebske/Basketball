...
Shader "Shader Forge/DefaultShader" {
    Properties {
        ...
        _SpecularAmount ("Specular Amount", Range(0, 1)) = 0.6837612
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip((_Albedo_var.a*(isFrontFace*0.0+1.0)) - 0.5);
...
///////// Gloss:
                ...
                float gloss = (_Gloss_var.r*_Roughness);
...
////// Specular:
                ...
                float3 specularColor = (_Specular_var.rgb*_SpecularAmount).r;
